...
class TestHolocleanRepair(unittest.TestCase):
    def test_hospital(self):
        ...
        hc = holoclean.HoloClean(pruning_topk=0.1, epochs=10, weight_decay=0.01,
                threads=4, batch_size=1, verbose=True, timeout=3*60000).session
        ...
        hc.repair_errors(featurizers, em_iterations=3, em_iter_func=eval_func)
